...
SUBMISSION_SMILES_FILEPATH = "/home/mila/g/golemofl/data/smiles-project/my_smiles_temperature_{90}.txt"
...
def generate_smiles(generated_smiles=300):
    ...
    with open(SUBMISSION_SMILES_FILEPATH, "a") as file:
        for _ in tqdm(range(generated_smiles)):
            new_smile = evaluate(model, vocabs, device, temperature=0.90)
            if new_smile[0] == "!":
